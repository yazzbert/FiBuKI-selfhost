  ...
  },
  {
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "clearUnconfirmed": {
          "type": "boolean",
          "description": "Clear assignments the matcher no longer reproduces (default true). False leaves them in place and only rewrites where a different partner now auto-applies."
        },
        "minConfidence": {
          "type": "number",
          "description": "Only stored assignments with confidence >= this value"
