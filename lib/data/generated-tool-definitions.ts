...
// Generated at: 2026-08-21T14:03:31.758Z
      ...
      "properties": {
        ...
        "declared": {
          ...
          "properties": {
            ...
            "typicalDayOfMonth": {
              "type": "number",
              "description": "Day of month the charge lands on (1-31)"
            },
            "expectedAmount": {
              "type": "object",
              ...
              "properties": {
                "min": {
                  "type": "number",
                  "description": "Lowest amount in cents (inclusive)"
                },
                "max": {
                  "type": "number",
                  "description": "Highest amount in cents (inclusive)"
                },
                "currency": {
                  "type": "string",
                  "description": "Currency of the band (default EUR)"
                }
              },
              "required": [
                "min",
  ...
  },
  {
    ...
    "inputSchema": {
      ...
      "properties": {
        "dateFrom": {
          "type": "string",
          "description": "Coverage range start inclusive (YYYY-MM-DD). Default: 12 months ago."
        },
        "dateTo": {
          "type": "string",
