 ...
 * Rendered client-side via @react-pdf/renderer <PDFViewer>.
 *
 * Keep in sync with functions/src/invoicing/invoiceDocument.tsx
 *
...
function formatAddress(addr?: PartnerAddress): string[] {
  if (!addr) return [];
  const lines: string[] = [];
