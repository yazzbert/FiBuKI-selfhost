...
exports.matchInvestmentColumns = void 0;
...
function buildPrompt(headers, sampleRows) {
    const fieldDescriptions = INVESTMENT_FIELDS.map((f) => `- **${f.key}** (${f.required ? "required" : "optional"}, type: ${f.type}): ${f.description}\n  Aliases: ${f.aliases.slice(0, 5).join(", ")}\n  Examples: ${f.examples.join(", ")}`).join("\n\n");
...
// Cloud Function
// ============================================================================
exports.matchInvestmentColumns = (0, https_1.onCall)({
    region: "europe-west1",
    memory: "256MiB",
    timeoutSeconds: 60,
}, async (request) => {
...
//# sourceMappingURL=matchInvestmentColumns.js.map